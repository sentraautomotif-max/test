  ...
  return (
    <section className="relative min-h-[90vh] flex items-center" id="cta-wa">
        ...
        <div className="hero-reveal max-w-2xl">
          ...
          <div className="mt-8 flex flex-col gap-4 sm:flex-row sm:items-center">
            <a
              href={waUrlPrimary}
              data-cta="wa_primary"
              className="animate-pulse-glow inline-flex items-center justify-center gap-2 bg-primary px-8 py-4 text-base font-semibold text-primary-foreground transition-colors hover:bg-primary/90"
            >
      ...
      <div className="absolute bottom-6 left-1/2 -translate-x-1/2 animate-float">
        <a href="#layanan" className="flex flex-col items-center gap-1 text-white/40 hover:text-white/70 transition-colors" aria-label="Scroll ke bawah">
