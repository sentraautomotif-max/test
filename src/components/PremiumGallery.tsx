      ...
      <div className="mx-auto max-w-6xl px-4">
        ...
        <div className="mt-12 grid gap-4 grid-cols-2 md:grid-cols-3">
          {galleryItems.map((item) => (
            ...
            >
              {/* Placeholder dengan label untuk foto yang akan diganti */}
              <div className="absolute inset-0 flex flex-col items-center justify-center bg-gradient-to-br from-zinc-800 via-zinc-700 to-zinc-900">
